        ...
        if (texure2d != null)
        {
            switch (state)
            {
                case State.Normal:
                    ...
                    {
                        texure2d.mainTexture = UiTextureResourceLoader.LoadUiTexture(mTextureOutNormal);
                    }
                    break;
                case State.Hover:
                case State.Pressed:
                    ...
                    {
                        texure2d.mainTexture = UiTextureResourceLoader.LoadUiTexture(mTextureOutPressed);
                    }
                    break;
            }
        }
