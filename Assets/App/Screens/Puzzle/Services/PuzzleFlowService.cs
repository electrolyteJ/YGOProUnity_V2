...
namespace App.Screens.Puzzle.Services
{
    public sealed class PuzzleFlowService
    {
        ...
        public PuzzleFlowService( PuzzleFlowCallbacks callbacks)
        {
        ...
        {
            return FileUtil.GetFilePath(PuzzleDirectoryName, (puzzleName ?? string.Empty) + PuzzleScriptExtension);
        }
        ...
        private FileInfo[] GetPuzzleFiles()
        {
            ...
            string directoryPath = FileUtil.GetDirectoryPath(PuzzleDirectoryName);
