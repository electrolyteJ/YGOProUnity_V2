...
namespace App.Features.Online.Services
{
    public sealed class OnlineFlowService
    {
        ...
        public OnlineFlowService()
            : this(new RuntimePlatformPaths(), new RuntimeFileStorage(), new OnlineFlowCallbacks())
        {
        }

        public OnlineFlowService(IPlatformPaths platformPaths, IFileStorage fileStorage, OnlineFlowCallbacks callbacks)
        {
        ...
        private string[] ReadHistoryLines()
        {
            ...
            string path = platformPaths.GetFilePath(ConfigDirectoryName, HostsFileName);
            ...
            return SplitLines(fileStorage.ReadAllText(path));
        }
        ...
        private void WriteHistoryLines(IList<string> entries)
        {
            ...
            fileStorage.WriteAllText(
                platformPaths.GetFilePath(ConfigDirectoryName, HostsFileName),
