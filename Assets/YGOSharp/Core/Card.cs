...
namespace YGOSharp
{
    public class Card
    {
        public static Func<int, Card> ExactLookup;

        public static string UnknownName = string.Empty;

        public static string UnknownDesc = string.Empty;
        ...
        public Card(IDataRecord reader)
        {
