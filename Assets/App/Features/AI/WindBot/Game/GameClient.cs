...
namespace WindBot.Game
{
    public class GameClient
    {
        ...
        public void Start()
        {
            ...
            System.Net.IPAddress target_address;
            try
            {
                target_address = System.Net.IPAddress.Parse(_serverHost);
            }
            catch (System.Exception)
            {
                // Unity IL2CPP may not support Dns.GetHostEntry, fallback to loopback
                target_address = System.Net.IPAddress.Loopback;
            }
